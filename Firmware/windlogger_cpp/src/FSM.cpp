...
void FSM::character_processing (){
	/// set when a string from usart0 finish by "\r\n"
...
void FSM::newState_definition(){
	// This is the logic bloc to define witch state will be the next
...
//	uart0.print(itoa(second_counter,conv_string,10));uart0.print("\r\n");
//	uart0.print(itoa(eeprom.measure_periode,conv_string,10));uart0.print("\r\n");
